...
static void SSTACK_MEMCPY_CHUNK(ssStack* _this, void* destination, void* source);
...
// specifically when one side is passed by the client, in which case we have to use the unpadded sizeof
void SSTACK_MEMCPY_CHUNK(ssStack* _this, void* destination, void* source)
...
bool SsStackPush(ssStack* _this, void* memory/*chunk*/) // todo
{
  ...
  SSTACK_MEMCPY_CHUNK(_this, chunk, memory);
...
struct ssStack
{
  ...
  SSTACK_MEMCPY_CHUNK(_this, memory, chunk);
