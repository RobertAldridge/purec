...
enum { CUBE_COUNT_DIMENSION = 8 };
enum { CUBE_SCALE = 10 };
enum { CUBE_NUM_INSTANCES = CUBE_COUNT_DIMENSION * CUBE_COUNT_DIMENSION * CUBE_COUNT_DIMENSION };
...
typedef struct {
    ...
    XrMatrix4x4f CubeTransforms[CUBE_NUM_INSTANCES];
} ovrSceneTransform;
...
static void RenderScene(
    ...
    for (int eye = 0; eye < ovrMaxNumEyes; eye++) {
        ...
        // Render cubes
        for (int i = 0; i < CUBE_NUM_INSTANCES; i++) {
            glUniformMatrix4fv(
