...
AConfiguration* AConfiguration_new() { return 0/*(AConfiguration*)malloc(sizeof(AConfiguration) )*/; }
void AConfiguration_delete(AConfiguration* config) { if(config)free(config); }
