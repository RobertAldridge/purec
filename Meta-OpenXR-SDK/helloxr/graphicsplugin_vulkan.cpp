...
struct SwapchainImageContext {
    ...
    // A packed array of XrSwapchainImageVulkan2KHR's for table.xrEnumerateSwapchainImages
...
#define MK_OBJECT_TYPE_CASE(name) \
                                             ...
                                             VkInstance* vulkanInstance, VkResult* vulkanResult)
    {
        ...
        CHECK_XRCMD(table.GetInstanceProcAddr(instance, "xrCreateVulkanInstanceKHR",
                                           ...
                                           VkDevice* vulkanDevice, VkResult* vulkanResult)
    {
        ...
        CHECK_XRCMD(table.GetInstanceProcAddr(instance, "xrCreateVulkanDeviceKHR",
                                                 ...
                                                 VkPhysicalDevice* vulkanPhysicalDevice)
    {
        ...
        CHECK_XRCMD(table.GetInstanceProcAddr(instance, "xrGetVulkanGraphicsDevice2KHR",
                                                       ...
                                                       XrGraphicsRequirementsVulkan2KHR* graphicsRequirements)
    {
        ...
        CHECK_XRCMD(table.GetInstanceProcAddr(instance, "xrGetVulkanGraphicsRequirements2KHR",
...
struct VulkanGraphicsPluginLegacy : public VulkanGraphicsPlugin {
                                             ...
                                             VkInstance* vulkanInstance, VkResult* vulkanResult) override
    {
        ...
        CHECK_XRCMD(table.GetInstanceProcAddr(instance, "xrGetVulkanInstanceExtensionsKHR",
                                           ...
                                           VkDevice* vulkanDevice, VkResult* vulkanResult) override
    {
        ...
        CHECK_XRCMD(table.GetInstanceProcAddr(instance, "xrGetVulkanDeviceExtensionsKHR",
                                                 ...
                                                 VkPhysicalDevice* vulkanPhysicalDevice) override
    {
        ...
        CHECK_XRCMD(table.GetInstanceProcAddr(instance, "xrGetVulkanGraphicsDeviceKHR",
                                                       ...
                                                       XrGraphicsRequirementsVulkan2KHR* graphicsRequirements) override
    {
        ...
        CHECK_XRCMD(table.GetInstanceProcAddr(instance, "xrGetVulkanGraphicsRequirementsKHR",
