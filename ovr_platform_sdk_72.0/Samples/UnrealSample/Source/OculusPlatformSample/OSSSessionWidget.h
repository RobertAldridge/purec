...
class OCULUSPLATFORMSAMPLE_API UOSSSessionWidget : public UUserWidget {
 ...
 public:
  UOSSSessionWidget(const FObjectInitializer& ObjectInitializer) : UUserWidget(ObjectInitializer) {
    ...
    OnSessionUserInviteAcceptedDelegate = FOnSessionUserInviteAcceptedDelegate::CreateUObject(
        this, &UOSSSessionWidget::OnSessionUserInviteAccepted);
    OculusSessionInterface->AddOnSessionUserInviteAcceptedDelegate_Handle(
        OnSessionUserInviteAcceptedDelegate);

    OnJoinSessionCompleteDelegate = FOnJoinSessionCompleteDelegate::CreateUObject(
        this, &UOSSSessionWidget::OnJoinSessionComplete);
  ...
  // 4.15 and earlier:   void OnFindFriendSessionComplete(int32 LocalUserNum, const bool
  // bWasSuccessful, const FOnlineSessionSearchResult& SearchResult);
