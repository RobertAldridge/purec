...
void UOSSFriendListWidget::ReadAllFriends() {
  ...
  OculusFriendsInterface->ReadFriendsList(
      ...
      FOnReadFriendsListComplete::CreateUObject(
          this, &UOSSFriendListWidget::OnReadFriendsListComplete));
}
...
void UOSSFriendListWidget::OnReadFriendsListComplete(
    int32 LocalUserNum,
...
void UOSSFriendListWidget::OnFindFriendSessionComplete(
    int32 LocalUserNum,
    const bool bWasSuccessful,
    const FOnlineSessionSearchResult& FriendSearchResult) {
